...
function LoginScreen(){
  ...
  useEffect(()=>{
    ...
    try{
      ...
      const TOTAL_MS=2900;      // hard cap — form + logo reveal no matter what
      const LOGO_FADE_AT=1700;  // logo starts fading in while cubes are still flying (this is the extra half-second hold on top of the original 1200ms)
